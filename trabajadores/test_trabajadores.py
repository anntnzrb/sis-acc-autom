...
class TrabajadorModelTest(TestCase):
    ...
    def test_model_ordering(self):
        ...
        Trabajador.objects.create(
            nombre='Carlos', apellido='Zambrano', correo='carlos@test.com',
            cedula='1111111111', codigo_empleado='EMP001'
        )
        Trabajador.objects.create(
            nombre='Ana', apellido='Pérez', correo='ana@test.com',
            cedula='2222222222', codigo_empleado='EMP002'
        )
        Trabajador.objects.create(
            nombre='Luis', apellido='Pérez', correo='luis@test.com',
            cedula='3333333333', codigo_empleado='EMP003'
        )
...
class TrabajadorViewTest(TestCase):
    ...
    def test_trabajador_create_view_post_valid(self):
        ...
        response = self.client.post(reverse('trabajadores:create'), data=self.valid_data)
    ...
    def test_trabajador_update_view_get(self):
        ...
        trabajador = Trabajador.objects.create(**self.valid_data)
        response = self.client.get(reverse('trabajadores:update', kwargs={'pk': trabajador.pk}))
    ...
    def test_trabajador_delete_view_get(self):
        ...
        trabajador = Trabajador.objects.create(**self.valid_data)
        response = self.client.get(reverse('trabajadores:delete', kwargs={'pk': trabajador.pk}))
    ...
    def test_trabajador_delete_view_post(self):
        ...
        trabajador = Trabajador.objects.create(**self.valid_data)
        response = self.client.post(reverse('trabajadores:delete', kwargs={'pk': trabajador.pk}))
